...
Ce théorème nous permet donc d'un part de facilement trouver une base de $E$ à partier d'un somme directe. 
Mais aussi, à partie d'une base de $E$ de le décomposer en somme directe. 
